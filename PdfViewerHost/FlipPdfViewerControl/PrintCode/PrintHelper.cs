...
{
	/// <summary>
	/// Adopted from a Microsoft sample.
	/// </summary>
    public class PrintHelper
    {
        ...
        /// </summary>
        protected UserControl hostControl;
		...
		protected Canvas PrintCanvas
        {
            get
            {
                return hostControl.FindName("PrintCanvas") as Canvas;
            }
        }
        ...
        public async Task ShowPrintUIAsync()
        {
            ...
            {
                HostErrorMsgHandler?.Invoke("Error printing: " + e.Message + ", hr=" + e.HResult);
            }
        }
        ...
        protected virtual void PrintTaskRequested(PrintManager sender, PrintTaskRequestedEventArgs e)
        {
            ...
            printTask = e.Request.CreatePrintTask("FlipPdfViewerControl", sourceRequested =>
            {
